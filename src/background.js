...
const accsess_token = process.env.ACCESS_TOKEN;
const accsess_token_secret = process.env.ACCESS_TOKEN_SECRET;
const consumer_key = process.env.CONSUMER_KEY;
const consumer_key_secret = process.env.CONSUMER_SECRET;

const twitterClient = new TwitterClient({
  apiKey: consumer_key,
  apiSecret: consumer_key_secret,
  accessToken: accsess_token,
  accessTokenSecret: accsess_token_secret
});
